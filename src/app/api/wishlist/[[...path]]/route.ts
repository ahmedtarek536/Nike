...
const BACKEND_URL = 'http://ecommerce232.runasp.net/api/Wishlist';
...
export async function GET(
  ...
  try {
    ...
    console.log('Wishlist proxy GET:', url);
...
export async function POST(
  ...
  try {
    ...
    console.log('Wishlist proxy POST:', url, body);
...
export async function DELETE(
  ...
  try {
    ...
    console.log('Wishlist proxy DELETE:', url);
    ...
    console.error('Wishlist proxy DELETE error:', error);
    return NextResponse.json(
